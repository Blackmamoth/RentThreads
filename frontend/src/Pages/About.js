...
const About = () => {
  return (
    <div className="relative overflow-hidden bg-white mt-14">
  <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
    <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
      <div className="sm:max-w-lg">
        <h1 className="font text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Lease Your Style - StyleLease</h1>
        <p className="mt-4 text-xl text-gray-500">At StyleLease, we believe that fashion should be accessible to everyone. We offer a unique solution to the problem of fast-paced fashion trends and overconsumption by providing a clothes renting service. 
        <br/>
        </p>
      ...
      <div>
        <div className="mt-10">
          ...
          <Link to="/" className="inline-block rounded-md border border-transparent bg-gray-900 py-3 px-8 text-center font-medium text-white hover:bg-gray-700">Shop Collection</Link>
        </div>
      </div>
    </div>
  </div>
